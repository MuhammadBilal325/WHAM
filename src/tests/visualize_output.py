...
Usage:
    python src/tests/visualize_output.py <path_to_output_npy> [--output <output_path>] [--fps 30] [--image_size 512] [--mode mesh]
"""
...
from src.utils.common.visualizer import visualize_smpl_results
