...
Usage:
    python src/tests/file_input.py <path_to_npy_file> [--output <output_path>] [--window_size 16] [--stride 1] [--device cuda]
"""
...
# From src/tests/file_input.py -> WHAM/ is 2 levels up
_PROJECT_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..'))
sys.path.insert(0, _PROJECT_ROOT)

from src.utils.common.datagram import parse_npy_datagrams
from src.utils.common.lifter import CameraSpaceLifter
